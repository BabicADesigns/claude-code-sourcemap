...
For a curated, collaborative catalog of open-source iOS, iPad, Apple TV, Apple Watch, and Vision Pro apps, see [Open Source iOS Apps](https://github.com/dkhamsing/open-source-ios-apps).
