...
For a curated collection of cheatsheets, manuals, one-liners, and CLI/web tools spanning Linux, security, DevOps, and sysadmin topics, see [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge).
