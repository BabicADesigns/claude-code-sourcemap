...
For a community-maintained, CC0-licensed catalog of leaked and extracted system prompts from various AI products (Claude, ChatGPT, Gemini, Grok, Copilot, and more), see [System Prompts Leaks](https://github.com/asgeirtj/system_prompts_leaks).
