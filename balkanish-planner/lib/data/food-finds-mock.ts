...
export const mockFoodFinds: FoodFind[] = [
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?braised+beef,wine+sauce,slow+cooked,dalmatia,sunday+roast",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?braised+beef,wine+sauce,slow+cooked,dalmatia,sunday+roast",
      alt: "Pašticada — slow-braised Dalmatian beef in dark wine sauce with gnocchi, served in a terracotta dish.",
      caption: {
        en: "Pašticada, simmered low and slow for a Sunday table.",
        de: "Pašticada, langsam geschmort für den Sonntagstisch.",
        it: "Pašticada, cotta lentamente per la tavola della domenica.",
        hr: "Pašticada, polako kuhana za nedjeljni stol.",
      },
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: true,
    ritual:
  ...
  },
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?roasted+lamb,wood+fire,embers,iron+pot,rustic+cooking",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?roasted+lamb,wood+fire,embers,iron+pot,rustic+cooking",
      alt: "Peka — rustic slow-roasted lamb and potatoes lifted from an iron bell over glowing embers.",
      caption: "Peka, slow-roasted under an iron bell.",
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: true,
    ritual:
  ...
  },
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?savory+pie,chard,flatbread,rustic+baked,herbs+garlic",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?savory+pie,chard,flatbread,rustic+baked,herbs+garlic",
      alt: "Soparnik — a thin savoury chard and garlic pie cut into diamond-shaped pieces, still warm from the embers.",
      caption: "Soparnik, baked directly on the embers.",
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: false,
    ritual:
  ...
  },
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?squid+ink+risotto,black+risotto,seafood+pasta,mediterranean+seafood",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?squid+ink+risotto,black+risotto,seafood+pasta,mediterranean+seafood",
      alt: "Crni rižot — jet-black cuttlefish ink risotto garnished with a drizzle of olive oil, served in a white bowl.",
      caption: "Crni rižot, the catch turned into supper.",
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: false,
    ritual:
  ...
  },
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?burek,filo+pastry,phyllo,balkan+pastry,baked+dough",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?burek,filo+pastry,phyllo,balkan+pastry,baked+dough",
      alt: "Burek — coiled filo pastry glistening with butter, pulled apart to reveal a rich cheese and meat filling.",
      caption: "Burek, still warm from the bakery.",
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: true,
    ritual:
  ...
  },
  {
    ...
    hero_image_url: "https://source.unsplash.com/featured/1200x800/?smoked+sausage,charcuterie,cured+meat,paprika+sausage,charcuterie+board",
    hero_image: {
      url: "https://source.unsplash.com/featured/1200x800/?smoked+sausage,charcuterie,cured+meat,paprika+sausage,charcuterie+board",
      alt: "Kulen — sliced Slavonian paprika sausage fanned on a wooden board alongside bread and sheep's cheese.",
      caption: "Kulen, cured through a Slavonian winter.",
      credit: { photographer: "Unsplash Community", source: "Unsplash" },
    },
    is_featured: false,
    ritual:
