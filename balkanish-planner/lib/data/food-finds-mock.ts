...
export const mockFoodFinds: FoodFind[] = [
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/pasticada-dish/1200/800",
      alt: "Editorial placeholder image of pašticada, slow-braised Dalmatian beef in wine sauce — to be replaced with real on-location photography.",
      caption: {
  ...
  },
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/peka-dish/1200/800",
      alt: "Editorial placeholder image of peka, meat and potatoes slow-roasted under an iron bell — to be replaced with real on-location photography.",
  ...
  },
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/soparnik-pie/1200/800",
      alt: "Editorial placeholder image of soparnik, a thin savoury chard pie baked under embers — to be replaced with real on-location photography.",
  ...
  },
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/crni-rizot/1200/800",
      alt: "Editorial placeholder image of crni rižot, cuttlefish-ink risotto — to be replaced with real on-location photography.",
  ...
  },
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/burek-pastry/1200/800",
      alt: "Editorial placeholder image of burek, flaky filo pastry rolled around cheese, meat, or spinach — to be replaced with real on-location photography.",
  ...
  },
  {
    ...
    hero_image: {
      url: "https://picsum.photos/seed/kulen-sausage/1200/800",
      alt: "Editorial placeholder image of kulen, a paprika-rich smoked sausage cured for months — to be replaced with real on-location photography.",
